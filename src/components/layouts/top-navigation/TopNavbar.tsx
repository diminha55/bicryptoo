...
const hasFrontend = process.env.NEXT_PUBLIC_FRONTEND === "true" || false;
const SearchResults = lazy(() =>
  import("../shared/SearchResults").then((module) => ({
    default: module.SearchResults,
  }))
);

const NotificationsDropdown = lazy(() =>
  import("../shared/NotificationsDropdown").then((module) => ({
    default: module.NotificationsDropdown,
  }))
);

const AccountDropdown = lazy(() =>
  import("../shared/AccountDropdown").then((module) => ({
      ...
      >
        <div className="flex justify-between items-center px-3">
          ...
          <div className="flex items-center justify-center">
            {isSidebarOpenedMobile && isAdmin && profile && (
