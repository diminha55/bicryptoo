...
const KycApplicationDetails = () => {
  ...
  const documentTypeLabels = {
    documentPassport: t("Passport"),
    documentDriversLicense: t("Driver's License"),
    documentIdCard: t("ID Card"),
  };
  ...
  const renderDocumentSection = (document, type) => (
    <div key={type} className="mb-4">
      <h4 className="text-lg font-semibold mb-2">{documentTypeLabels[type]}</h4>
