...
const P2pOffers = () => {
  ...
  const handleDeposit = async () => {
    if (!amount) return toast.error("Please enter the amount to deposit");
  ...
  const handleWithdraw = async () => {
    if (!amount) return toast.error("Please enter the amount to withdraw");
    if (!selectedOffer)
            ...
            <div className="p-4 md:p-6">
              <div className="flex gap-x-2 justify-end">
                <Button
                  ...
                  disabled={
                    wallet ? amount > wallet?.balance : false || isLoading
                  }
                  loading={isLoading}
                >
                  {t("Deposit")}
            ...
            <div className="p-4 md:p-6">
              <div className="flex gap-x-2 justify-end">
                <Button
                  ...
                  disabled={amount > selectedOffer.amount || isLoading}
                  loading={isLoading}
                >
                  {t("Withdraw")}
                </Button>
