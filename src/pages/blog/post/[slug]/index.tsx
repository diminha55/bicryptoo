...
import { ContentBlock } from "@/components/elements/base/content";
...
export default function Post() {
  ...
  const contentObj = safeJSONParse(content); // Parse content safely into an object
  return (
    <Layout title={title || "Blog"} color="muted">
      <TracingBeam>
        <div className="max-w-prose mx-auto antialiased pt-4 relative">
          ...
          <div className="prose prose-invert mx-auto max-w-prose prose-pre:max-w-[90vw] pe-20 md:pe-0">
