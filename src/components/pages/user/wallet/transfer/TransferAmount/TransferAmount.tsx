...
// Displays transferal details like min/max amounts and fees
    ...
    <div>
      <div className="mb-12 space-y-1 text-center font-sans">
        <h2 className="text-2xl font-light text-muted-800 dark:text-muted-100">
          {selectedCurrency}
          {t("to")} {selectedTargetCurrency} {t("Transfer Confirmation")}
        </h2>
  ...
  return (
    <TransferForm
      ...
      onBack={() => {
        ...
        setSelectedTargetCurrency("Select a currency");
        setStep(1);
      }}
