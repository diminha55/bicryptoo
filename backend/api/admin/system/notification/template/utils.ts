...
const emailBody = baseStringSchema("Body content for email notifications");
const smsBody = baseStringSchema("Body content for SMS notifications");
const pushBody = baseStringSchema("Body content for push notifications");
